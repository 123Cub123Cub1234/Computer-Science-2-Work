/**
 * Description: Creates Platinum Pro Tier class and methods needed for the platinum pro tier (mileage, multiplier, and flights)
...
public class Platinum_Pro extends Tier 
{
	/**
	...
	private int miles;
	private int flights;
	private String tier = "Platinum Pro";
	...
	public Platinum_Pro (int cancelledFlights)
	{
