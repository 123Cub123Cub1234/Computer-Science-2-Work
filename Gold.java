/**
 * Description: Creates Gold Tier class and methods needed for the gold tier (mileage, multiplier, and flights)
...
public class Gold extends Tier 
{
	...
	public Gold (int cancelledFlights)
	{
	...
	/**
	 * @param Nothing is implemented
	 * @return String as tier
	 * @throws Nothing is implemented
	 */
	
	public String sendTierName()
	{
		return tier;
	}
